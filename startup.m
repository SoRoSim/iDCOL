...
% mex -O -outdir mex -I"." -I"..\eigen-3.4.0" mex\idcol_newton_mex.cpp core\shape_core.cpp
% mex -O -outdir mex -I"." -I"..\eigen-3.4.0" mex\idcol_newton_s_mex.cpp core\shape_core.cpp %speed check
